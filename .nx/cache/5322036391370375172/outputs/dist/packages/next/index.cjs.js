...
function createFormattedMDXError(error, source) {
    ...
    const codeFrames = position
        ? codeFrame.codeFrameColumns(source, {
            start: {
...
class ContentNext extends core.Content {
    /**
    ...
    async getStaticPaths(context, fallback = "blocking", routeType = "", asString) {
        ...
        const normalisedRouteType = core.normalisePathname(routeType) + "/";
...
exports.ContentNext = ContentNext;
exports.kjam = kjam;
