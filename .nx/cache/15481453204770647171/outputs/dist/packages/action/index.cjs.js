...
function log(err, data) {
    ...
    if (err) core__namespace.error(err);
}
var Git = /*#__PURE__*/ function() {
    function Git(baseDir, afterFetch) {
        ...
        Object.entries(this.outputs).forEach(function(param) {
            ...
            return core__namespace.setOutput(name, value);
        });
    }
    _create_class(Git, [
        {
            ...
            value: function run() {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                git = simpleGit__default["default"]({
                                ...
                                core__namespace.info("Running in folder ".concat(_this.baseDir, "..."));
                            ...
                            case 3:
                                ...
                                core__namespace.info("> Found ".concat(changedFiles, " changed files."));
                                return [
                                    4,
        ...
        },
        {
            ...
            value: function logOutputs() {
                ...
                for(var key in this.outputs){
                    core__namespace.info("".concat(key, ": ").concat(this.outputs[key]));
                }
                core__namespace.endGroup();
            }
        },
            ...
            value: function success() {
                if (this.errors.length === 1) {
                    ...
                    this.errors.forEach(function(e) {
                        return core__namespace.error(e);
                    });
