export declare namespace Kjam {
     ...
     * ```
     */
    type Translations = Record<Locale, Record<"*" | "~" | string, Record<string, string | {
        [key: string]: string;
    }>>>;
}
/**
 ...
 */
export type Entry<Data = {}> = EntryMatter<Data> & EntryRoute & EntryMeta;
/**
...
export type EntriesMapById<Data = {}> = Record<Kjam.RouteId, Record<Kjam.Locale, Entry<Data>>>;
